...
>눈앞에 실제로, 구체적으로 존재하는 사물이 있다면 반드시 그것의 **본질**이 존재한다. ㅡ 플라톤
...
> - 언어의 의미란 인간이 언어놀이로 만들어 낸 것이다.  
  ㅡ [비트겐슈타인 후기 사상: 용도의미론(the use theort of meaning)](https://imnt.tistory.com/207)
